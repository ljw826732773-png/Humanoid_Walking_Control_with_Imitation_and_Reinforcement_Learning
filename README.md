...
本次改进把平均步数从 97.5 提升到 624.3，最好步数从 133 提升到 785，已经达到“平均 300+ 步稳定行走”的阶段性目标。
...
- 完成状态/动作归一化改进，将 BC 评估平均步数从 97.5 提升到 624.3，最好步数从 133 提升到 785。
- 对比不同算法在短时步态稳定性和存活步数上的表现，分析归一化、训练轮数和闭环控制稳定性之间的关系。
