...
if __name__ == "__main__":
    ...
    if os.path.exists(pretrained_model_path):
        try:
            ...
            model = SAC.load(pretrained_model_path, env=train_env, device=device, custom_objects=custom_objects)
            print("预训练模型加载成功")
    ...
    # 开始训练（1,000,000 步）
    try:
        model.learn(total_timesteps=1000000, reset_num_timesteps=False, callback=callback, log_interval=1,
